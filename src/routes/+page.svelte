    ...
    <div class="bg-[#19191c] flex-col flex h-[93vh] justify-between max-sm:pt-5 md:pt-20 pb-8 max-sm:gap-7">
        ...
        <div class="flex-col self-center lg:w-[40vw] md:w-[50vw] sm:w-[80vw] mx-5 gap-4 flex">
            ...
            <div class="flex gap-7">
                <a href="https://discordapp.com/users/676926873669992459" target="_blank" class="hover:brightness-125 transition duration-110 ease-in-out">
                    <img src="/img/discord.png" class="h-14 hover:brightness-125">
                </a>
